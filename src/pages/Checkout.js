...
function Checkout() {
  ...
  const handleQuantity = (e, item) => {
    dispatch(updateUserAsync({ ...item, quantity: +e.target.value }));
  };
          ...
          <div className="lg:col-span-3">
            ...
            >
              <div className="space-y-12">
                ...
                {/* Addres and Reset button Functionlity */}
                <div className="mt-6 flex items-center justify-end gap-x-6">
                  {/* Reset Button of addres form */}
                  <button
                    type="button"
                ...
                {/* Address and Payument Method Radio Button Functionly */}
                <div className="border-b border-gray-900/10 pb-12">
